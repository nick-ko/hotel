                            ...
                            <tr class="tr-shadow">
                                ...
                                <td>
                                    <div class="table-data-feature">
                                        <a href="{{URL::to('dashboard/edit-user/'.$user->id)}}" class="item" data-toggle="tooltip" data-placement="top" title="Editer">
                                            <i class="zmdi zmdi-edit"></i>
                                        </a>
                                        <a href="{{URL::to('dashboard/delete-user/'.$user->id)}}" class="item" data-toggle="tooltip" data-placement="top" title="Supprimer">
