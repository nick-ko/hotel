                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="price" name="book_contact" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="+225 00 00 00 00">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <select name="motif" id="motif" class="wide form-control">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <select name="pays" id="" class="form-control selectpicker" data-show-subtext="true" data-live-search="true">
