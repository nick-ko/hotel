    ...
    <section class="breadcrumb_area">
        ...
        <div class="container">
            <div class="page-cover text-center">
                <h2 class="page-cover-tittle">{{$r->room_name}}</h2>
                <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-6 d_flex align-items-center">
                    <form action="{{url('/dashboard/save-booking')}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="title" name="book_name" type="text" class="form-control" aria-required="true" aria-invalid="false" required >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="price" name="book_lname" type="text" class="form-control" aria-required="true" aria-invalid="false" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="price" name="book_email" type="text" class="form-control" aria-required="true" aria-invalid="false" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="price" class="control-label mb-1">Votre Contact</label>
                                            <input id="price" name="book_contact" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="+225 00 00 00 00" required>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            <label for="motif" class="control-label mb-1">Motif du voyage</label>
                                            <select name="motif" id="motif" class="wide form-control" required>
                                                <option value="">Selectionnez le motif de votre voyage</option>
                                                <option value="business">Business</option>
                                                <option value="tourisme">Tourisme</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label for="motif" class="control-label mb-1">Votre pays</label>
                                            <select name="pays" id="" class="form-control selectpicker" required data-show-subtext="true" data-live-search="true">
                                                <option value="">votre pays d'origine</option>
                        ...
                        <br>
                        <button type="submit" class="btn btn-block btn-warning" style="cursor: pointer"> Reserver</button>
                    </form>
                </div>
                <div class="col-md-6" id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <a class="carousel-item active" href="{{URL::to($r->room_image)}}">
                        <img src="{{URL::to($r->room_image)}}" class="card-img" alt="..." style="width:750px; height:400px;">
                    </a>
                    <a class="carousel-item" href="{{URL::to($r->room_photo)}}">
                        <img src="{{URL::to($r->room_photo)}}" class="card-img" alt="..." style="width:750px; height:400px;">
                    </a>
                    </div>
